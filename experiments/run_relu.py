...
if __name__ == "__main__":
    ...
    for _ in range(1):
        run_batch(FFNReluModel, sp_blocks=10, warmup_steps=1, eval_steps=3, batch_sizes=[8_000], save_name="./results/test_relu.csv")
        run_batch(FFNRelu2Model, sp_blocks=10, warmup_steps=1, eval_steps=3, batch_sizes=[8_000], save_name="./results/test_relu.csv")
